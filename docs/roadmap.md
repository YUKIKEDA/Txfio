...
| Phase 1 MVP | 完了 |
| Phase 2 並行性・ロック | 完了 |
| Phase 3 拡張と公開 | 進行中（次は README の操作分岐 Issue #69） |

Phase 3 の実装（Issue #33、#35、#37、#39、#45、#47、#49、#51、#57、#67）と利用者向け README（Issue #41、#54）、設計（Issue #43、#53、#65）は main にある。次は README の操作分岐（Issue #69）。公開（nuget.org）はその後。
