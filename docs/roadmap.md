...
Phase 3 の実装（Issue #33、#35、#37、#39、#45、#47、#49、#51、#57、#67、#73、#79）と利用者向け README（Issue #41、#54、#69、#75）、設計（Issue #43、#53、#65、#71、#77、#109、#117）は main にある。次は ZIP アーカイブの作成（Issue #111）と展開（Issue #113）、README（Issue #115）、組で指定する作成（Issue #119）。公開（nuget.org）はその後。
