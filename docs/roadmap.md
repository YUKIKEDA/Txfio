...
| Phase 1 MVP | 完了 |
| Phase 2 並行性・ロック | 完了 |
| Phase 3 拡張と公開 | 進行中（次は README の条件分岐の図 Issue #75） |

Phase 3 の実装（Issue #33、#35、#37、#39、#45、#47、#49、#51、#57、#67、#73）と利用者向け README（Issue #41、#54、#69）、設計（Issue #43、#53、#65、#71）は main にある。次は README の条件分岐の図（Issue #75）。公開（nuget.org）はその後。
...
- Issue #75: README の操作ごとの条件分岐を図にする
