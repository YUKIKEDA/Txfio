...
public interface ITransaction : IAsyncDisposable
{
    ...
    /// <exception cref="InvalidDataException">展開先の外へ出る名前、Windows で使えない名前、`.txnew` で終わる名前、重複、ファイルとディレクトリの同名がある、またはエントリの展開後のサイズの合計が <paramref name="maxExtractedBytes"/> を超える（ZIP 自体が読めないときも同じ）</exception>
