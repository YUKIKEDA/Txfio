...
internal sealed class JournalOperation
{
    ...
    /// <param name="isDirectory">ディレクトリの Delete、DeleteTree、またはディレクトリの Move なら <see langword="true"/></param>
    [JsonConstructor]
    ...
    /// <summary>
    /// ディレクトリの Delete、DeleteTree、またはディレクトリの Move なら <see langword="true"/>
    /// </summary>
